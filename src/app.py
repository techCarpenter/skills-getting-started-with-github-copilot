...
activities = {
    ...
    "Basketball Club": {
        "description": "Improve shooting, dribbling, and defensive skills through drills and games",
        "schedule": "Tuesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["ava@mergington.edu", "mia@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore drawing, painting, and mixed media projects in a creative studio",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["grace@mergington.edu", "zoe@mergington.edu"]
    },
    "Drama Club": {
        "description": "Develop acting skills, stage presence, and performance techniques",
    ...
    "Science Club": {
        "description": "Conduct hands-on experiments and explore scientific concepts beyond the classroom",
